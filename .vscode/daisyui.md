...
daisyUI 5 is a CSS library for Tailwind CSS daisyUI 5 provides class names for
...
fieldset-legend as a title and fieldset-label as a description
...
- Add all indicator elements (with `indicator-item` class) before the main
  content
- {placement} is optional and can have one of each horizonal/vertical class
